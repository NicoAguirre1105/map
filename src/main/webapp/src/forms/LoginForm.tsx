...
const LoginForm = ({setWindow}: LayoutProps) => {
    ...
    const {form, errors, loading, response, handleChange, handleBlur, handleSubmit} = useForm(initialForm, validateForm, handleEnd, "Login")
        ...
        <>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="options">
                    <p onClick={() => {setWindow("Password")}}>Forgot Password?</p>
                </div>
            ...
            <p>No account? <strong onClick={()=>{setWindow("Register")}}>Register now</strong></p>
        </>
    )
}
