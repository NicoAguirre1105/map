...
export function Message({type, content}:MessagePrompt) {
    
    return (
        <>
            <div className={`message-window ${type}`}>
                {type === "done" && 
                ...
                <h4 className={type}>Congratulations!</h4>
                </div>}
                {type === "error" && 
                <div className="title-container">
